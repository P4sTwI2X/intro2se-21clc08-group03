...
export default function Header() {
  return (
    <nav className="bg-lime-700 border-none dark:bg-gray-900 grid grid-rows-2 gap-0">
      ...
      <div className="flex flex-wrap items-center justify-center mx-auto space-x-10 mb-5">
        <h1 className="font-bold text-white text-4xl">BuyMee</h1>
        ...
        <Link
          to="/cart"
          className="relative block py-2 pl-3 pr-4 text-white hover:text-yellow-600 rounded"
          aria-current="page"
        >
